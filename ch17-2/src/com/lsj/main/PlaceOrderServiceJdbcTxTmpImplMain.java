...
public class PlaceOrderServiceJdbcTxTmpImplMain {
	private PlaceOrderService placeOrderService;
	
	public PlaceOrderServiceJdbcTxTmpImplMain() {
		String[] configLocations = new String[] { "dataSource.xml", "transactionTwo.xml" };
	...
	public void order(){
		...
		orderRequest.setAddress("서울 동대문구");
	...
	public static void main(String[] args) {
		try{
			PlaceOrderServiceJdbcTxTmpImplMain test = new PlaceOrderServiceJdbcTxTmpImplMain();
			test.order();			
		}catch(Exception e){
			e.printStackTrace();
		}
